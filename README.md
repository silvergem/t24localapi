...
| CREATE.HOLD.CONTROL.REC         | Batch Function Routine   | .POST or .SELECT(Using Control list) Batch Routine                | Create record on HOLD.CONTROL Application | | **Y.RPT.CONTROL** = Report control name <br /> **Y.RPT.DIR** = File Directory <br /> **Y.RPT.NAME** = File Name <br /> **Y.RPT.EXT** = File Name Ext **Y.ERR** = Error | Catalogue routine
